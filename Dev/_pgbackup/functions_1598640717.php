...
function grupo_roland13_customize_register( $wp_customize ) {
    ...
    $wp_customize->add_section( 'seta_icon', array(
        'title' => __( 'Seta do Icone', 'grupo_roland13' )
    ));
    ...
    $wp_customize->add_setting( 'landing_page_botão_link', array(
        'type' => 'theme_mod',
        'default' => '<span style="color: #000000;">Saiba Mais</span> <img alt="" class="ml-2" src="assets/images/arrow-black.png" cms-editable="icon_link" cms-editable-type="image" cms-editable-label="Icone de link" cms-editable-section="seta_icon"/>',
        'sanitize_callback' => $pgwp_sanitize
    ));
    ...
    $wp_customize->add_setting( 'portaria_remota_botão_link', array(
        'type' => 'theme_mod',
        'default' => '<span style="color: #000000;">Leia Mais </span> <img src="assets/images/arrow-black.png" alt="" class="ml-2" cms-editable="icon_link" cms-editable-type="image" cms-editable-label="Icone de link" cms-editable-section="seta_icon"/>',
        'sanitize_callback' => $pgwp_sanitize
    ));
