...
/*
    ...
    register_nav_menu(  'primary', __( 'Principal', 'grupo_roland13' )  );
...
function grupo_roland13_customize_register( $wp_customize ) {
    ...
    $wp_customize->add_section( 'logo', array(
        'title' => __( 'Logo do Menu', 'grupo_roland13' )
    ));

    $wp_customize->add_section( 'botao_chamada', array(
        'title' => __( 'Botão de Chamada', 'grupo_roland13' )
    ));

    $wp_customize->add_section( 'blocks_copyright_1', array(
        'title' => __( 'Copyright 1', 'grupo_roland13' )
    ));
    ...
    $wp_customize->add_section( 'porter', array(
        'title' => __( 'Página Portaria Remota Porter', 'grupo_roland13' )
    ));
    ...
    $wp_customize->add_setting( 'botao_chamada_botao', array(
        'type' => 'theme_mod',
        'default' => __( 'Button', 'grupo_roland13' ),
        'sanitize_callback' => $pgwp_sanitize
    ));

    $wp_customize->add_control( 'botao_chamada_botao', array(
        'label' => __( 'Nome do Botão de Chamada', 'grupo_roland13' ),
        'type' => 'text',
    ...
    $wp_customize->add_control( 'botao_chamada_link', array(
        'label' => __( 'Link do Botão', 'grupo_roland13' ),
        'type' => 'url',
        'section' => 'botao_chamada'
    ));
    ...
    $wp_customize->add_setting( 'blocks_copyright_1_text_left', array(
        'type' => 'theme_mod',
        'default' => __( '© pgblocks - Pinegrow Blocks', 'grupo_roland13' ),
        'sanitize_callback' => $pgwp_sanitize
    ));

    $wp_customize->add_control( 'blocks_copyright_1_text_left', array(
        'label' => __( 'Left Text', 'grupo_roland13' ),
        'type' => 'textarea',
    ...
    $wp_customize->add_setting( 'porter_imagem01', array(
        'type' => 'theme_mod',
        'sanitize_callback' => $pgwp_sanitize
    ));

    $wp_customize->add_control( new WP_Customize_Media_Control( $wp_customize, 'porter_imagem01', array(
        'label' => __( 'Imagem 01', 'grupo_roland13' ),
        'type' => 'media',
        'mime_type' => 'image',
        'section' => 'porter'
    ...
    $wp_customize->add_setting( 'porter_imagem02', array(
        'type' => 'theme_mod',
        'sanitize_callback' => $pgwp_sanitize
    ));

    $wp_customize->add_control( new WP_Customize_Media_Control( $wp_customize, 'porter_imagem02', array(
        'label' => __( 'Imagem 02', 'grupo_roland13' ),
        'type' => 'media',
        'mime_type' => 'image',
        'section' => 'porter'
    ...
    $wp_customize->add_setting( 'porter_imagem03', array(
        'type' => 'theme_mod',
        'sanitize_callback' => $pgwp_sanitize
    ));

    $wp_customize->add_control( new WP_Customize_Media_Control( $wp_customize, 'porter_imagem03', array(
        'label' => __( 'Imagem 03', 'grupo_roland13' ),
        'type' => 'media',
        'mime_type' => 'image',
        'section' => 'porter'
    ...
    $wp_customize->add_setting( 'porter_porter_orcamento', array(
        'type' => 'theme_mod',
        'default' => __( 'Solicite contato', 'grupo_roland13' ),
        'sanitize_callback' => $pgwp_sanitize
    ));

    $wp_customize->add_control( 'porter_porter_orcamento', array(
        'label' => __( 'Orçamento', 'grupo_roland13' ),
        'type' => 'text',
        'section' => 'porter'
    ));

    $wp_customize->add_setting( 'porter_porter_orcamento_link', array(
        'type' => 'theme_mod',
        'sanitize_callback' => $pgwp_sanitize
    ));

    $wp_customize->add_control( 'porter_porter_orcamento_link', array(
        'label' => __( 'Link', 'grupo_roland13' ),
        'type' => 'url',
        'section' => 'porter'
    ));
    ...
    $wp_customize->add_setting( 'porter_porter_orcamento', array(
        'type' => 'theme_mod',
        'default' => __( 'Quero saber mais', 'grupo_roland13' ),
        'sanitize_callback' => $pgwp_sanitize
    ));
...
if ( ! function_exists( 'grupo_roland13_enqueue_scripts' ) ) :
    ...
    wp_deregister_script( 'grupo_roland13-plugins' );
    wp_enqueue_script( 'grupo_roland13-plugins', get_template_directory_uri() . '/components/pg.blocks.wp/js/plugins.js', false, null, true);

    wp_deregister_script( 'grupo_roland13-bskitscripts' );
    wp_enqueue_script( 'grupo_roland13-bskitscripts', get_template_directory_uri() . '/components/pg.blocks.wp/js/bskit-scripts.js', false, null, true);

    wp_deregister_script( 'grupo_roland13-script' );
    wp_enqueue_script( 'grupo_roland13-script', 'https://maps.google.com/maps/api/js?sensor=true', false, null, true);

    wp_deregister_script( 'jquery' );
    wp_enqueue_script( 'jquery', get_template_directory_uri() . '/assets/js/jquery.min.js', false, null, true);

    wp_deregister_script( 'grupo_roland13-bootstrap-1' );
    wp_enqueue_script( 'grupo_roland13-bootstrap-1', get_template_directory_uri() . '/bootstrap/js/bootstrap.min.js', false, null, true);

    wp_deregister_script( 'grupo_roland13-owlcarousel' );
    wp_enqueue_script( 'grupo_roland13-owlcarousel', 'https://cdnjs.cloudflare.com/ajax/libs/OwlCarousel2/2.2.1/owl.carousel.min.js', false, null, true);

    wp_register_script( 'inline-script-1', '', [], '', true );
    wp_enqueue_script( 'inline-script-1' );
    wp_add_inline_script( 'inline-script-1', '$(".owl-carousel").owlCarousel({
      loop: true,
      margin: 20,
      nav: true,
      navText: [],
    ...
    wp_add_inline_script( 'inline-script-2', '$(".nav_search-btn").click(function () {
    ...
    wp_deregister_script( 'grupo_roland13-popper-1' );
    wp_enqueue_script( 'grupo_roland13-popper-1', get_template_directory_uri() . '/assets/js/popper.js', false, null, true);

    wp_deregister_script( 'grupo_roland13-plugins-1' );
    wp_enqueue_script( 'grupo_roland13-plugins-1', get_template_directory_uri() . '/components/pg.blocks/js/plugins.js', false, null, true);

    wp_deregister_script( 'grupo_roland13-bskitscripts-1' );
    wp_enqueue_script( 'grupo_roland13-bskitscripts-1', get_template_directory_uri() . '/components/pg.blocks/js/bskit-scripts.js', false, null, true);
    ...
    wp_deregister_style( 'grupo_roland13-blocks' );
    wp_enqueue_style( 'grupo_roland13-blocks', get_template_directory_uri() . '/components/pg.blocks.wp/css/blocks.css', false, null, 'all');

    wp_deregister_style( 'grupo_roland13-plugins' );
    wp_enqueue_style( 'grupo_roland13-plugins', get_template_directory_uri() . '/components/pg.blocks.wp/css/plugins.css', false, null, 'all');

    wp_deregister_style( 'grupo_roland13-stylelibrary' );
    wp_enqueue_style( 'grupo_roland13-stylelibrary', get_template_directory_uri() . '/components/pg.blocks.wp/css/style-library-1.css', false, null, 'all');

    wp_deregister_style( 'grupo_roland13-style-1' );
    wp_enqueue_style( 'grupo_roland13-style-1', 'http://fonts.googleapis.com/css?family=Open+Sans:300italic,400italic,600italic,700italic,400,300,600,700', false, null, 'all');

    wp_deregister_style( 'grupo_roland13-style-2' );
    wp_enqueue_style( 'grupo_roland13-style-2', 'http://fonts.googleapis.com/css?family=Lato:300,400,700,300italic,400italic,700italic', false, null, 'all');

    wp_deregister_style( 'grupo_roland13-fontawesome' );
    wp_enqueue_style( 'grupo_roland13-fontawesome', 'https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css', false, null, 'all');

    wp_deregister_style( 'grupo_roland13-owlcarousel' );
    wp_enqueue_style( 'grupo_roland13-owlcarousel', 'https://cdnjs.cloudflare.com/ajax/libs/OwlCarousel2/2.1.3/assets/owl.carousel.min.css', false, null, 'all');

    wp_deregister_style( 'grupo_roland13-bootstrap-1' );
    wp_enqueue_style( 'grupo_roland13-bootstrap-1', get_template_directory_uri() . '/bootstrap/css/bootstrap.min.css', false, null, 'all');

    wp_deregister_style( 'grupo_roland13-style-3' );
    wp_enqueue_style( 'grupo_roland13-style-3', 'https://fonts.googleapis.com/css?family=Open+Sans:300,400,600,700|Roboto:400,500&display=swap', false, null, 'all');

    wp_deregister_style( 'grupo_roland13-style-4' );
    wp_enqueue_style( 'grupo_roland13-style-4', get_template_directory_uri() . '/css/style.css', false, null, 'all');

    wp_deregister_style( 'grupo_roland13-responsive' );
    wp_enqueue_style( 'grupo_roland13-responsive', get_template_directory_uri() . '/css/responsive.css', false, null, 'all');

    wp_deregister_style( 'grupo_roland13-blocks-1' );
    wp_enqueue_style( 'grupo_roland13-blocks-1', get_template_directory_uri() . '/components/pg.blocks/css/blocks.css', false, null, 'all');

    wp_deregister_style( 'grupo_roland13-plugins-1' );
    wp_enqueue_style( 'grupo_roland13-plugins-1', get_template_directory_uri() . '/components/pg.blocks/css/plugins.css', false, null, 'all');

    wp_deregister_style( 'grupo_roland13-stylelibrary-1' );
    wp_enqueue_style( 'grupo_roland13-stylelibrary-1', get_template_directory_uri() . '/components/pg.blocks/css/style-library-1.css', false, null, 'all');

    wp_deregister_style( 'grupo_roland13-style-5' );
    wp_enqueue_style( 'grupo_roland13-style-5', 'https://fonts.googleapis.com/css?family=Open+Sans:300italic,400italic,600italic,700italic,400,300,600,700', false, null, 'all');

    wp_deregister_style( 'grupo_roland13-style-6' );
    wp_enqueue_style( 'grupo_roland13-style-6', 'https://fonts.googleapis.com/css?family=Lato:300,400,700,300italic,400italic,700italic', false, null, 'all');
